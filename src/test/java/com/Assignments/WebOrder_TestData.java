...
import com.Assignments.ReadExcel;

public class WebOrder_TestData {
	@DataProvider(name = "Login")		//DataProvider is the annotation by TestNG to read the data
...
//				};
	...
	public Object[][] ReadDataFromExcel() throws Exception{
		...
		Object[][] testObjArray = excel.getExcelData(RelativePath+"\\TestDataFile\\WebOrder_TestData.xls","Login");
